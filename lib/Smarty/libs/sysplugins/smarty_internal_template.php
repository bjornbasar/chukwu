...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase
{
	 ...
	 * @param Smarty $smarty
	 *        	Smarty instance
	 * @param Smarty_Internal_Template $_parent
	 *        	back pointer to parent object with variables or null
	 * @param mixed $_cache_id
	 *        	cache id or null
	 * @param mixed $_compile_id
	 *        	compile id or null
	 * @param bool $_caching
	 *        	use caching?
	...
	public function mustCompile ()
	{
		...
		{
			$this->mustCompile = (! $this->source->uncompiled && ($this->smarty->force_compile || $this->source->recompiled || $this->compiled->timestamp === false || ($this->smarty->compile_check && $this->compiled->timestamp < $this->source->timestamp)));
		}
	 ...
	 *        	
	 * @return s string template content
	 */
